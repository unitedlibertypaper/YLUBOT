<?php
//=========التوكن=========//
$token = "5961802647:AAGBi9_po7CThb33ubgIhl21kfe3EWklGZ8"
fine("API_KEY", $token);
...
⋄︙ [تحديثات السورس الجديده](https://t.me/$userbot = "UnitedLibertyUnionBOT";
)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/$userbot = "UnitedLibertyUnionBOT";
"]],
]])
]); 
}
...
⌯⁞ لعرض الايدي ~⪼ `{Id}`
⌯⁞ قناة تعين : [@$userbot = "UnitedLibertyUnionBOT";
]
",'parse_mode'=>"MARKDOWN",'reply_to_message_id'=>$message_id,]);}
...
'parse_mode'=>'MarkDown', 'disable_web_page_preview'=>true,
 ...
 'reply_markup'=>json_encode([
'inline_keyboard'=>[
[['text'=>"",'url'=>"t.me/$userbot = "UnitedLibertyUnionBOT";
"]],
]])
]);
}}}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/$userbot = "UnitedLibertyUnionBOT";
"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
